...
class ListOfDoctors extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsets.all(18), width: MediaQuery
        .of(context)
        .size
        .width / 2.24, decoration: BoxDecoration(
      color: Colors.white,
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center,
        children: [
          ...
          SizedBox(height: 20,),
          Text("Dr . ${doctor.name}", style: TextStyle(fontSize: 18,
              letterSpacing: -.5,
              color: Colors.black,
              fontWeight: FontWeight.bold),),
          SizedBox(height: 5,),
          Text(doctor.specialist, style: TextStyle(color: Colors.black,
            letterSpacing: 0,
            fontWeight: FontWeight.bold,),),
          SizedBox(height: 20,),
          Container(
